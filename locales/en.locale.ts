export const en = {
    ...
    errors: {
        ...
        pay_upgrade_error: "An error occurred while purchasing the upgrade",
    ...
    you_have_spin_per_day: "YOU HAVE $$$ SPIN PER DAY",
    you_have_spins_per_day: "YOU HAVE $$$ SPINS PER DAY",
    upgrade_text: "You can increase your number of daily spins up to 16 claims per day.",
    increase_to_spins: "Increase to $$$ spins/day",
    pay_ton: "PAY $$$ TON",
    pay: "PAY",
    spin_now: "SPIN NOW",
    reached_maximum_daily_spins: "You have reached the maximum of daily spins.",
    succesfully_bought: "SUCCESSFULLY BOUGHT",
    you_increased_number_of_spins: "You increased your number of daily spins to $$$.",
    ...
    how_much_spins_for_frens: "HOW MUCH SPIN-POINS FOR FRENS",
    how_much_spins: "HOW MUCH SPIN-POINTS",
    how_much_Text_1: "Verified frens you will bring you Spin Points.",
    how_much_Text_2: "To be Verified Friend need to join our socials and make First claim.",
    from_to_verified_fens: "FROM $$$ TO $$$$ VERIFIED FRENS",
    from_verified_fens: "FROM $$$ VERIFIED FRENS",
    spins_for_every_frens: "2 spin-points for every $$$ verified frens",
    get_2_spins: "GET 2 SPIN POINTS",
    you_got_2_spins: "You got 2 Spin Points",
    game_over: "THE GAME IS OVER. ALL TOKENS HAVE BEEN DISTRIBUTED.",
    check: "CHECK",
    raid_task_is_done: "RAID TASK IS DONE",
    raid_task_is_missed: "RAID TASK IS MISSED",
    connect_twitter: "CONNECT X/TWITTER",
